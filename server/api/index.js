...
if(enableAuth) {
  ...
  // app.patch('/api/v1/notes(|*)', authorize(['notes:all', 'notes:write']));
   ...
   app.get('/api/v1/categories(|/*)', authorize(['categories:all', 'categories:read']));
  // app.get('/api/v1/notes(|/*)');
  app.post('/api/v1/categories(|/*)', authorize(['categories:all', 'categories:read']));
  app.put('/api/v1/categories(|/*)', authorize(['categories:all', 'categories:edit']));
}
